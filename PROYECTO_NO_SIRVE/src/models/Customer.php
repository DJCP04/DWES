...
class Customer extends Model
{
    ...
    public function save()
    {
        ...
        try {
            ...
            if (isset($this->employee_id)) {
                $sql = "INSERT INTO $table(customers_id,cust_first_name,cust_last_name,cust_street_address,cust_postal_code,cust_city,cust_state,cust_country,phone_numbers,nls_language,nls_territory,credit_limit,cust_email,account_mgr_id,cust_geo_location,date_of_birth,marital_status,gender,income_level)
                VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?,?,?,?,?)
            VALUES(
    ...
    public function destroy(){
        ...
        try{
            ...
            if(isset($this->employee_id)){
                $sql = "SELECT * FROM $table WHERE customer_id =$this->employee_id";
